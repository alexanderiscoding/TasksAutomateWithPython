#python MergeJsonAllOnlyFile.py example1.json example2.json... infinite files in only file
import json
import sys
            ...
            with open(convertedfilename, encoding="utf-8") as file:
                ...
                with open(item, encoding="utf-8") as file:
                    ...
                    with open(convertedfilename, 'w', encoding='utf8') as outfile:
                        json.dump({**data_all, **data}, outfile, sort_keys = True, indent = 4, ensure_ascii = False)
        except FileNotFoundError:
            with open(item, encoding="utf-8") as file:
                data = json.loads(file.read())
                with open(convertedfilename, 'w', encoding='utf8') as outfile:
